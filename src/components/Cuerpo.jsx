                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="max-w-sm bg-white border border-gray-100 rounded-lg shadow dark:bg-gray-900 dark:border-gray-300 transform transition-transform hover:scale-105">
                            ...
                            <div className="p-5">
                                ...
                                <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray-900 bg-amber-200 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-amber-200 dark:hover:bg-amber-800 dark:hover:text-white dark:focus:ring-gray-800">
                                    Read more
                        ...
                        <div className="max-w-sm bg-white border border-gray-100 rounded-lg shadow dark:bg-gray-900 dark:border-gray-300 transform transition-transform hover:scale-105">
                            ...
                            <div className="p-5">
                                ...
                                <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray-900 bg-amber-200 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-amber-200 dark:hover:bg-amber-800 dark:hover:text-white dark:focus:ring-gray-800">
                                    Read more
                                    <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                                    </svg>
                ...
                <div className="container mx-auto text-center flex justify-center">
                    ...
                    <div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-900 dark:border-gray-900">
                        <div class="flex items-center justify-between mb-4">
                            <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Últimos Clientes</h5>
